    ...
    return (
      ...
      >
        <View className="flex-row justify-start w-[100%]shadow-sm">
          ...
          <FontAwesome
            name={bookmarkStatus[index] ? "heart-o" : "heart"} // "heart" is solid, "heart-o" is outlined
            size={hp(2.5)} // Set the size as needed
            color={bookmarkStatus[index] ? "gray" : "red"} // "red" for bookmarked, "gray" for not bookmarked
          />
        </TouchableOpacity>
          </View>
        </View>
